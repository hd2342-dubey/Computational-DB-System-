...
<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './cse.php'">CSE</button>
                </li>
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './me.php'">ME</button>
                </li>
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './ece.php'">ECE</button>
                </li>
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './ce.php'">CE</button>
                </li>
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './appsci.php'">App. Sci.</button>
                </li>
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './non_teaching.php'">Non Teaching</button>
                </li>
                <li class="nav-item">
                    <button style="border:none;" class="btn btn-outline-light me-2" onclick="window.location.href = './lab.php'">Labs</button>
                </li>
                <li class="nav-item">
        ...
        <div class='pull-right'>
            <form class="form-inline pull-right" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
    ...
    <div class='pull-right'>
        <form class="form-inline pull-right" method="post" action="./header.php">
            <div class="input-group float-end">
