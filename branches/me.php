...
<head>
    ...
    <title>Mechanical Faculty</title>
...
<body>
    ...
    <div style='width:90vw; margin:auto auto; font-weight:700; color:blue'>Summary of computational items assigned to Mechanical dept:
<marquee behaviour="scroll" direction="left" scrollamount="4" style="font-size: 16px;padding-top: 0px;font-weight:550; margin:auto auto; color:blue">
    ...
    while ($re = mysqli_fetch_assoc($r)) {
        ...
        $query .= "FROM no_items_assigned NATURAL JOIN department WHERE dept_type='teaching' and dept_name='ME'; ";
    ...
    $query .= "WHERE a.id=b.id AND dept_name='ME'; ";
    $list = mysqli_query($connection, $query); ?>
